...
export default function Process() {
  ...
  return (
    ...
    //           </h3>
    //           <h4 className="mt-2 text-base text-gray-700">
    //             Submit your documents and specifiy your requirements
    //           </h4>
    //         </div>
    //       </li>
    //       <li className="flex-start group relative flex lg:flex-col">
    ...
    //           </h3>
    //           <h4 className="mt-2 text-base text-gray-700">
    //             We focus on your content with care, precision, and QA checks to
    //             ensure accuracy and client satisfaction.
    //           </h4>
    //         </div>
    //       </li>
    //       <li className="flex-start group relative flex lg:flex-col">
    ...
    //           </h3>
    //           <h4 className="mt-2 text-base text-gray-700">
    //             That's it! We'll deliver your translations via email.
    //           </h4>
    //         </div>
    //       </li>
    //     </ul>
